...
namespace hyphaspace
{
    ...
    public:
        ...
        const flexvalue DOES_NOT_EXIST = -42069;  // arbitrary, hopefully never used value
        ...
        content_group get_content_group (const document &document, const string &content_group_label, const bool &strict);
